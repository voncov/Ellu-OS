/*_BSD Zero Clause License */

/*_Copyright (C) 2022-2025 mintsuki and contributors.
...
#define LIMINE_REQUESTS_START_MARKER \
    UINT64 limine_requests_start_marker[4] = { 0xf6b8f4b39de7d1ae, 0xfab91a6940fcb9cf, \
                                                 0x785c6ed015d3e316, 0x181e920a7852b9d9 };
#define LIMINE_REQUESTS_END_MARKER \
    UINT64 limine_requests_end_marker[2] = { 0xadc0e0531bb10d03, 0x9572709f31764c62 };

#define LIMINE_REQUESTS_DELIMITER LIMINE_REQUESTS_END_MARKER

#define LIMINE_BASE_REVISION(N) \
    UINT64 limine_base_revision[3] = { 0xf9562b2d5c95a6c8, 0x6a7b384944536bdc, (N) };
...
#define LIMINE_TERMINAL_CTX_SIZE ((UINT64)(-1))
#define LIMINE_TERMINAL_CTX_SAVE ((UINT64)(-2))
#define LIMINE_TERMINAL_CTX_RESTORE ((UINT64)(-3))
#define LIMINE_TERMINAL_FULL_REFRESH ((UINT64)(-4))

/*_Response revision 1 */
#define LIMINE_TERMINAL_OOB_OUTPUT_GET ((UINT64)(-10))
#define LIMINE_TERMINAL_OOB_OUTPUT_SET ((UINT64)(-11))
...
typedef VOID (*limine_terminal_write)(struct limine_terminal *, const char *, UINT64);
typedef VOID (*limine_terminal_callback)(struct limine_terminal *, UINT64, UINT64, UINT64, UINT64);
